  ...
  <div class="content">
    ...
    <section>
        <div class="container py-4 px-5">
          <div class="row g-0">
            <div class="col-sm-6 col-md-8 py-3"> Data Kriteria & Bobot </div>
          </div>
          <table class="table table-striped">
            <thead>
              <tr>
                ...
                <th class="col-lg-3">Nama Kriteria</th>
                <th class="col-lg-1">Bobot</th>
				        <th class="col-lg-2">Atribut</th>
                <th class="col text-center">Aksi</th>
              </tr>
            </thead>
            <tbody>
              <?php
              $query = mysqli_query($koneksi, "SELECT * FROM kriteria order by kode");
              ...
              while($row=mysqli_fetch_array($query)) {
                echo "<tr>";
                  ...
                  echo "<td> <a class='btn btn-success btn-sm px-4 mx-2' href='formEditBobot.php?id_kriteria=$row[id_kriteria]'> Edit   
                  <a class='btn btn-danger btn-sm px-3' href='deleteBobot.php?id_kriteria=$row[id_kriteria]'> Hapus
                  </td>";
                  $no++;
      }
      ?>
          ...
          <a class="btn btn-dark" href="formBobot.php" role="button"> Tambah </a>
        </div>
    </section>
    </div>
  </div>
