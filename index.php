  ...
  <div class="content">
    ...
    <section>
        <div class="container py-4 px-5">
          <form nama="myForm" class="row g-3" action ="tambah_tanggal.php" method ="post">
          <div class="col mt-2">
							<label for="dataset" class="form-label">Tambah Tanggal Perekrutan</label>
							<input type="date" class="form-control" name="dataset" id="dataset" autocomplete="off" required>
						</div>
          <div class="row align-self-center"> 
					<div class="col">
						<button type="submit" class="btn btn-dark" name="submit" value="">Tambah</button>
					</div>
				</div>
      </form>
    </section>
          ...
          <tbody>
              ...
              while($row=mysqli_fetch_array($query)) {
                ...
                echo "<td> $no </td>";
                  ...
                  echo "<td>  <a class='btn btn-success btn-sm px-3 mx-2 align-self-center' href='data_alternatif.php?id_dataset=$row[id_dataset]'> Pilih 
                  </td>";
                  $no++;
      }
      ?>  
