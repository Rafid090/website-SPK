  ...
  <div class="content">
    ...
    <section>
        <div class="container py-4 px-5">
          ...
          <div class="col mt-2">
							<label for="dataset" class="form-label"> Pilih Posisi Calon Karyawan</label>
						</div>
            <table class="table table-striped" style="font-size: 16px;">
            <thead>
              <tr>
                <th class="col-lg-4">No</th>
                <th class="col-lg-7">Nama Posisi</th>
                <th class="col text-center">Aksi</th>
              </tr>
            </thead>
          <tbody>
              <?php
              $query = mysqli_query($koneksi, "SELECT distinct * FROM posisi, dataset where id_dataset='$id'");
              ...
              while($row=mysqli_fetch_array($query)) {
                ...
                echo "<td> $no </td>";
                  ...
                  echo "<td>  <a class='btn btn-success btn-sm px-3 mx-2 align-self-center' href='hasil.php?id_posisi=$row[id_posisi]&&id_dataset=$id'> Tampilkan 
                  </td>";
                  $no++;
      }
      ?>  
