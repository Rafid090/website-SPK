  ...
  <div class="content">
    ...
    <section>
        <div class="container py-4 px-5">
            ...
            <?php
                            ...
                            while($data = mysqli_fetch_array($query)) {
                                ...
                                while($data3 = mysqli_fetch_array($query3)){
                                    echo "<td style='text-align: center;'>$data3[nilai]</td>";
                                }

                                echo "<td>  <a class='btn btn-success btn-sm px-4 mx-2 align-self-center' href='deleteNilai.php?id_karyawan=$data[id_karyawan]&&id_dataset=$id'> Edit Nilai </td>";
                            }
                        ?>
            </tbody>
          </table>
          ...
          <?php
          echo "<a class='btn btn-dark' href='formNilai.php?id_dataset=$id' role='button'> Tambah </a>"; ?>
        </div>
    </section>
    </div>
  </div>
